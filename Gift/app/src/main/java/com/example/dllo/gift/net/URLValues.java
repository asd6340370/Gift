...
public final class URLValues {
    ...
    public static final String DISCOVER_BANNER = "http://api.liwushuo.com/v2/banners";
    public static final String DISCOVER_SPECIAL_LIST = "http://api.liwushuo.com/v2/secondary_banners?gender=2&generation=1";
}
